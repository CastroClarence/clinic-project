<?php
    ...
    if(isset($_POST["submitInfoOld"])){
        ...
        echo $mobileNum = $_POST["mobileNum"];
    ...
    function disableInput(){
        ...
        document.getElementById('mobileNum').readOnly = true;</script>";
    }
?>
<!DOCTYPE html>
  <html lang="en">
            ...
            <div class="am-body">
               ...
               <form class="am-body-box" action = "oldPatient.php" autocomplete="off" method = "post">
                    <div class="am-row">
                        ...
                        <div class="am-col-6">
                            <p>Mobile Number</p>
                            <input type="text" name="mobileNum" id="mobileNum" placeholder="Enter Mobile Number">
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="datePicker">
                        ...
                        <?php 
                            if(($errorPrompt["emailRegExist"] == "" and (!empty($_POST["submitInfoOld"]))) or ($errorPrompt["emailRegExist"] == "" and (!empty($_POST["submitSelectDateOld"])))){
                                ...
                                document.getElementById('mobileNum').value = '{$_SESSION["mobileNum"]}';</script>";
